...
\input{chapters/ObjectExp.tex}
\input{chapters/methods.tex}
\input{chapters/experiment.tex}
\input{chapters/dis-conclusion.tex}
...
\addtocontents{toc}{\vspace{3pt}}%fix vertical space for Table of Content
\liite{2}
\input{sample/appendix2.tex}

\addtocontents{toc}{\vspace{11pt}}
\liite{3}
\input{sample/appendix3.tex}

\addtocontents{toc}{\vspace{3pt}}
\liite{4}
\input{sample/appendix4.tex}

\addtocontents{toc}{\vspace{11pt}}
\liite{5}
\input{sample/appendix5.tex}
