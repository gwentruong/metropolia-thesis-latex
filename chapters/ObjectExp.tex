...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm]{biomass}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm]{original_pipe}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=8cm]{staticmixer}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm]{Voxer_view1}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=8cm]{Voxer_view2}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=6.5cm]{flowinpipe}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=10cm]{flow_profile}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{with_voxer}
