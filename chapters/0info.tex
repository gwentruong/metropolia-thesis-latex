...
\def\alaotsikko{Experimental fluid dynamics of Voxer on water cooling piping system in Keravan Energy } %if you don't have subtitle, empty {} it (but don't delete that line)
...
\def\metropoliakeywords {SansOx,vortex, Voxer, fluid mechanics, reduce energy consumption, reduce turbulence, pressure loss, viscous flow}
\date{\longmonth\today}
